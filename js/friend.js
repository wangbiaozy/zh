...
$(function(){
    ...
    function countDown(){
        ...
        var targetDate = new Date('2019/4/14 23:59:59');
    ...
    $('#start-btn').on('click',function(){
        switch (supplies){
            case 0:
            $('#suppliesText').text('阳光');
            $('#suppliesImg').attr('src',imgPath+'/fri_yg.png');
            break;
            case 1:
            $('#suppliesText').text('肥料');
            $('#suppliesImg').attr('src',imgPath+'/fri_fl.png');
            break;
            case 2:
            $('#suppliesText').text('水壶');
            $('#suppliesImg').attr('src',imgPath+'/fri_sh.png');
            break;
        }
        $('.fri-tc').show();
        showMask();
