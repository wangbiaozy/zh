...
$(function(){
    ...
    function showCountText(){
        ...
        if(ygCount !== 0){
            $('#ygCountText').show();
            $('#ygCountText').parent().removeClass('act sharetc');
        }else{
            $('#ygCountText').hide();
            $('#ygCountText').parent().addClass('act sharetc');
        }
        if(shCount !== 0){
            $('#shCountText').show();
            $('#shCountText').parent().removeClass('act sharetc');
        }else{
            $('#shCountText').hide();
            $('#shCountText').parent().addClass('act sharetc');
        }
        if(flCount !== 0){
            $('#flCountText').show();
            $('#flCountText').parent().removeClass('act sharetc');
        }else{
            $('#flCountText').hide();
            $('#flCountText').parent().addClass('act sharetc');
        }
    };
    showCountText();
    //倒计时
