...
$(function(){
    ...
    $('.yg').on('click', function () {
        document.getElementById("sunEffects").style.display = 'block';
        document.getElementById("sunEffects").className = 'a-fadeoutBig';
        setTimeout(function () {
            document.getElementById("sunEffects").style.display = 'none';
        }, 3000);
    });
    ...
    $('.fl').on('click',function(){
        var $this = $(this);
        if($this.hasClass('a-ring')){
            $this.attr('class','shifei aa');
        }
    });
