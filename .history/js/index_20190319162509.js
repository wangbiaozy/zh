    ...
    $('.yg').on('click', function () {
        if (ygFlag) {
            if (ygCount > 0) {
                ...
                setTimeout(function () {
                    $('#sunEffects').attr('class', 'a-ring yg').hide().siblings().show();
                    ygFlag = true;
                    flFlag = true;
                    shFlag = true;
                    $('#wl').text('添加了阳光');
    ...
    $('.fl').on('click',function(){
        if (flFlag) {
            if (flCount > 0) {
                ...
                setTimeout(function () {
                    $("#fertilizerEffects").attr('class', 'a-ring fl').hide().siblings().show();
                    flFlag = true;
                    ygFlag = true;
                    shFlag = true;
                    $('#wl').text('施肥');
    ...
    $('.sh').on('click', function () {
        if (shFlag) {
            if (shCount > 0) {
                ...
                setTimeout(function () {
                    $('#bottle').attr('class', 'a-ring sh').hide().siblings().show();
                    shFlag = true;
                    ygFlag = true;
                    flFlag = true;
                    $('#wl').text('浇水');
